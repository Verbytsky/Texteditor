...
public class Txtedit extends Frame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (arg.equals("About Text Editor")) {
			AboutDialog d1 = new AboutDialog(this, "About Text Editor");
			d1.setVisible(true);
			setSize(500, 500);
		}
	}
	...
	public class MyWindowsAdapter extends WindowAdapter {
		...
		public MyWindowsAdapter(Txtedit ttt) {
			tt = ttt;
		}
